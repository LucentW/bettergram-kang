...
call :repl "Argument= (Publisher=)&quot;CN=536BC709-8EE1-4478-AF22-F0F0F26FF64A&quot;/ $1&quot;CN=Bettergram LLC, O=Bettergram LLC, L=London, C=GB&quot;" "Filename=%ResourcePath%" || goto :error
